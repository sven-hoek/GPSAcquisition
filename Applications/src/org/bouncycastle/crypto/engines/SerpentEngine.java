...
//        System.arraycopy(kPad, 8, w, 0, 8);
        ...
        for(int i = 0; i<128; i+=32){
        	sb3(w[0+i], w[1+i], w[2+i], w[3+i]);
        	w[0+i] = X0; w[1+i] = X1; w[2+i] = X2; w[3+i] = X3; 
        	sb2(w[4+i], w[5+i], w[6+i], w[7+i]);
        	w[4+i] = X0; w[5+i] = X1; w[6+i] = X2; w[7+i] = X3; 
        	sb1(w[8+i], w[9+i], w[10+i], w[11+i]);
        	w[8+i] = X0; w[9+i] = X1; w[10+i] = X2; w[11+i] = X3; 
        	sb0(w[12+i], w[13+i], w[14+i], w[15+i]);
        	w[12+i] = X0; w[13+i] = X1; w[14+i] = X2; w[15+i] = X3; 
        	sb7(w[16+i], w[17+i], w[18+i], w[19+i]);
        	w[16+i] = X0; w[17+i] = X1; w[18+i] = X2; w[19+i] = X3; 
        	sb6(w[20+i], w[21+i], w[22+i], w[23+i]);
        	w[20+i] = X0; w[21+i] = X1; w[22+i] = X2; w[23+i] = X3; 
        	sb5(w[24+i], w[25+i], w[26+i], w[27+i]);
        	w[24+i] = X0; w[25+i] = X1; w[26+i] = X2; w[27+i] = X3; 
        	sb4(w[28+i], w[29+i], w[30+i], w[31+i]);
        	w[28+i] = X0; w[29+i] = X1; w[30+i] = X2; w[31+i] = X3; 
        } 
...
//		no speedup bc no loop  - this loop runs but is not synth correctly
        for(int i = 0; i< 128; i+=32){
//        	System.out.println(wKey.length);
        	sb0(wKey[i+0] ^ X0, wKey[i+1] ^ X1, wKey[i+2] ^ X2, wKey[i+3] ^ X3); LT();
        	sb1(wKey[i+4] ^ X0, wKey[i+5] ^ X1, wKey[i+6] ^ X2, wKey[i+7] ^ X3); LT();
        	sb2(wKey[i+8] ^ X0, wKey[i+9] ^ X1, wKey[i+10] ^ X2, wKey[i+11] ^ X3); LT();
        	sb3(wKey[i+12] ^ X0, wKey[i+13] ^ X1, wKey[i+14] ^ X2, wKey[i+15] ^ X3); LT();
        	sb4(wKey[i+16] ^ X0, wKey[i+17] ^ X1, wKey[i+18] ^ X2, wKey[i+19] ^ X3); LT();
        	sb5(wKey[i+20] ^ X0, wKey[i+21] ^ X1, wKey[i+22] ^ X2, wKey[i+23] ^ X3); LT();
        	sb6(wKey[i+24] ^ X0, wKey[i+25] ^ X1, wKey[i+26] ^ X2, wKey[i+27] ^ X3); LT();
