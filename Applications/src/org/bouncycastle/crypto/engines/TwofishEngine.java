...
public class TwofishEngine
{
    ...
    private static int P_00, P_01, P_02, P_03, P_04;
    private static int P_10, P_11, P_12, P_13, P_14;
    private static int P_20, P_21, P_22, P_23, P_24;
    private static int P_30, P_31, P_32, P_33, P_34;
	...
	this.P = P;
        ...
        ROUNDS = 16;
        MAX_ROUNDS = 16;  // bytes = 128 bits
        BLOCK_SIZE = 16;  // bytes = 128 bits
        MAX_KEY_BITS = 256;
    
        INPUT_WHITEN=0;
        OUTPUT_WHITEN=INPUT_WHITEN+BLOCK_SIZE/4; // 4
        ROUND_SUBKEYS=OUTPUT_WHITEN+BLOCK_SIZE/4;// 8
    
        TOTAL_SUBKEYS=ROUND_SUBKEYS+2*MAX_ROUNDS;// 40
        ...
        gMDS0 = new int[MAX_KEY_BITS];
        gMDS1 = new int[MAX_KEY_BITS];
        gMDS2 = new int[MAX_KEY_BITS];
        gMDS3 = new int[MAX_KEY_BITS];
...
//        	System.out.print(" ");
	    ...
	    boolean c0 = ((k64Cnt & 3) == 0);
	    boolean c1 = ((k64Cnt & 3) == 1);
	    boolean c2 = ((k64Cnt & 3) == 2);
	    boolean c3 = ((k64Cnt & 3) == 3);
	    if (c1) {
