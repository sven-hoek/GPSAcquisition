...
public final class WhirlpoolDigest 
{
	...
	for (int i = 0; i < _bitCount.length; i++) _bitCount[i] = 0;
	for (int i = 0; i < _buffer.length; i++) _buffer[i] = 0;
	for (int i = 0; i < _hash.length; i++) _hash[i] = 0;
	for (int i = 0; i < _K.length; i++) _K[i] = 0;
	for (int i = 0; i < _L.length; i++) _L[i] = 0;
	for (int i = 0; i < _block.length; i++) _block[i] = 0;
	for (int i = 0; i < _state.length; i++) _state[i] = 0;
