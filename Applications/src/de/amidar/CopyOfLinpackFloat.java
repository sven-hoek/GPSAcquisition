...
public class CopyOfLinpackFloat {

	  public static void main(String[] args)
	  {
	    CopyOfLinpackFloat l = new CopyOfLinpackFloat();
//	    for(int i = 0; i< 100; i++)
	    l.run_benchmark();
	  }
		  ...
		  if (nm1 >=  0) {
			  for (k = 0; k < nm1; k++) {
				  ...
				  if (col_k[l] != 0) {
					  ...
					  for(int step = kp1&0xFFFFFFF0; step < n; step= step +STEP ){
						  int length = STEP;
						  int start = step;
						  if(start < kp1){
							  start = kp1;
...
//						  System.out.println("Start: " + start + " step: " + step);
						  ...
						  for (j = kp1; j < n; j=j+8) {
							  ...
							  daxpy2(length,t1,t2,t3,t4,t5,t6,t7,t8,col_k,start,1,
									  col_j1,col_j2,col_j3,col_j4,col_j5,col_j6,col_j7,col_j8,start,1);
						  }
					  }
				  }
				  else {
