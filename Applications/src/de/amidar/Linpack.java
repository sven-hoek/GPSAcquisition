...
public class Linpack {
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    for(int i = 0; i< 100 ; i++){
	    	int off = rand.nextInt(200);
	    	System.out.println(off+200);
	    	l.run_benchmark(off);
	    }
	  }
	  ...
	  public void run_benchmark(int nOffset) 
	  {
	    ...
	    double adummy[][] = new double[500][501];
	    double bdummy[] = new double[500];
...
//	    dgesl(adummy,ldadummy,ndummy,ipvtdummy,bdummy,0);
	...
	*/
		...
		mflops_result = (int)(mflops_result*1000*1000);
		mflops_result /= 1000;
	...
	matrix in column order. --dmd 3/3/97
	  ...
	  */
	  ...
	  {
		  double[] col_k, col_j1, col_j2, col_j3, col_j4;
			  ...
			  for (k = 0; k < nm1; k++) {
				  ...
				  if (col_k[l] != 0) {
					  ...
					  for (j = kp1; j < n; j=j+4) {
						  ...
						  daxpy2(n-(kp1),t1,t2,t3,t4,col_k,kp1,1,
								  col_j1,col_j2,col_j3,col_j4,kp1,1);
					  }
				  }
				  else {
					  info = k;
...
//		  }System.out.println();
	  ...
	  */
	  final void daxpy2( int n, double da1, double da2, double da3, double da4, double dx[], int dx_off, int incx,
			  double dy1[], double dy2[],double dy3[],double dy4[], int dy_off, int incy)
	  {
		  int i,ix,iy;
