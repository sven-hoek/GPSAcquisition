...
public class SkipjackTest_sbe_orig_short {
	...
	SkipjackTest_sbe_orig_short skipjacktest = new SkipjackTest_sbe_orig_short(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_sbe_orig_short(byte[] key) {
	this.key = key;
    }
