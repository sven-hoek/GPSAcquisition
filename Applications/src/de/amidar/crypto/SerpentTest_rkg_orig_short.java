...
public class SerpentTest_rkg_orig_short {
	...
	SerpentTest_rkg_orig_short serpenttest = new SerpentTest_rkg_orig_short(key);
	serpenttest.run(data);

    }

    public SerpentTest_rkg_orig_short(byte[] key) {
	this.key = key;
    }
