...
public class SkipjackTest_rkg_orig_short {
	...
	SkipjackTest_rkg_orig_short skipjacktest = new SkipjackTest_rkg_orig_short(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_rkg_orig_short(byte[] key) {
	this.key = key;
    }
