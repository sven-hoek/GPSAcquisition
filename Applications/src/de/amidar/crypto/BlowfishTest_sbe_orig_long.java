...
public class BlowfishTest_sbe_orig_long {
    ...
    public static void main(String[] args) {
        ...
        BlowfishTest_sbe_orig_long blowfishtest = new BlowfishTest_sbe_orig_long(key);
        blowfishtest.run(data);
    
    }
    
    public BlowfishTest_sbe_orig_long(byte[] key) {
    	this.key = key;
    }
