...
public class TwofishTest_rkg_orig_long {
	...
	TwofishTest_rkg_orig_long twofishtest = new TwofishTest_rkg_orig_long(key);
	twofishtest.run(data);

    }

    public TwofishTest_rkg_orig_long(byte[] key) {
	this.key = key;
    }
