...
public class SerpentTest_rkg_orig_long {
	...
	SerpentTest_rkg_orig_long serpenttest = new SerpentTest_rkg_orig_long(key);
	serpenttest.run(data);

    }

    public SerpentTest_rkg_orig_long(byte[] key) {
	this.key = key;
    }
