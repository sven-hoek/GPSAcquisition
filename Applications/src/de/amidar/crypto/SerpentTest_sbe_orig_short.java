...
public class SerpentTest_sbe_orig_short {
	...
	SerpentTest_sbe_orig_short serpenttest = new SerpentTest_sbe_orig_short(key);
	serpenttest.run(data);

    }

    public SerpentTest_sbe_orig_short(byte[] key) {
	this.key = key;
    }
