...
public class BlowfishTest_rkg_orig_long {
    ...
    public static void main(String[] args) {
        ...
        BlowfishTest_rkg_orig_long blowfishtest = new BlowfishTest_rkg_orig_long(key);
        blowfishtest.run(data);
    
    }
    
    public BlowfishTest_rkg_orig_long(byte[] key) {
        this.key = key;
    }
