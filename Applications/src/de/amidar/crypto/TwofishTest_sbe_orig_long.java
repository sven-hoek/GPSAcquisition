...
public class TwofishTest_sbe_orig_long {
	...
	TwofishTest_sbe_orig_long twofishtest = new TwofishTest_sbe_orig_long(key);
	twofishtest.run(data);

    }

    public TwofishTest_sbe_orig_long(byte[] key) {
	this.key = key;
    }
