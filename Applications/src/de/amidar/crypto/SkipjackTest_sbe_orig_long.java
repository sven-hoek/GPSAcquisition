...
public class SkipjackTest_sbe_orig_long {
	...
	SkipjackTest_sbe_orig_long skipjacktest = new SkipjackTest_sbe_orig_long(key);
	skipjacktest.run(data);

    }

    public SkipjackTest_sbe_orig_long(byte[] key) {
	this.key = key;
    }
