...
public class SerpentTest_sbe_orig_long {
	...
	SerpentTest_sbe_orig_long serpenttest = new SerpentTest_sbe_orig_long(key);
	serpenttest.run(data);

    }

    public SerpentTest_sbe_orig_long(byte[] key) {
	this.key = key;
    }
