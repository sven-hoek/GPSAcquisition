...
public class BlowfishTest_sbe_orig_short {
    ...
    public static void main(String[] args) {
        ...
        BlowfishTest_sbe_orig_short blowfishtest = new BlowfishTest_sbe_orig_short(key);
        blowfishtest.run(data);
    
    }
    
    public BlowfishTest_sbe_orig_short(byte[] key) {
        this.key = key;
    }
