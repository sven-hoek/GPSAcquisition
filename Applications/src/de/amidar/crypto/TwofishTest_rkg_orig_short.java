...
public class TwofishTest_rkg_orig_short {
	...
	TwofishTest_rkg_orig_short twofishtest = new TwofishTest_rkg_orig_short(key);
	twofishtest.run(data);

    }

    public TwofishTest_rkg_orig_short(byte[] key) {
	this.key = key;
    }
