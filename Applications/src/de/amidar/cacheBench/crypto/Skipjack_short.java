...
public class Skipjack_short {
	...
	public static void main(String[] args) {
		...
		Skipjack_short skipjacktest = new Skipjack_short(key);
		skipjacktest.run(dataShort);
		//    skipjacktest.run(dataLong);


	}

	public Skipjack_short(byte[] key) {
		this.key = key;
	}
